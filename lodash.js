...
const myEmployeesAddresses = _.map(myEmployees, ({ address }) => address); // use map to get addresses here.

// Now we want to use map to get an array of ages of the employees.

const myEmployeesAges = _.map(myEmployees, ({ age }) => age); // use map to get ages here.
